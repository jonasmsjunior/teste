                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <?php
                                if($solicitacao->status_atual == 1){
                                    echo anchor("solicitacao_certidao/acompanhar/$solicitacao->uid/$solicitacao->idcomarca",
                        ...
                        <td><?php
                            if($solicitacao->status_atual == 3){
                                echo anchor("solicitacao_certidao/pdf/$solicitacao->uid/$solicitacao->idcomarca",'Imprimir <img alt="Editar" width="25" src="'.base_url('includes/tabela/icones/printer_inkjet.png').'">');
                            }
                            ?>
                        </td>
                      </tr>
