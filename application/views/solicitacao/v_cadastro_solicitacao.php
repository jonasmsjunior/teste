<section class="info_service">
    <div class="container">
        <form method="post" class="form-horizontal" action="<?= base_url('solicitacao_certidao/solicitar') ?>">
            <fieldset>
                <!-- Form Name -->
                <legend>Solicitação de Certidão Negativa</legend>
                ...
                <div class="control-group col-sm-4">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">
                        	 Ação Cível
                        	<input type="checkbox" class="form-checklist"  name="tipo_certidao_civel" value="1" <?=set_checkbox('tipo_certidao_civel', '1'); ?>>
                        </span>
                        
                        <span class="input-group-addon">
                        	 Ação Criminal
                        	<input type="checkbox" class="form-checklist"  name="tipo_certidao_criminal" value="2" <?=set_checkbox('tipo_certidao_criminal', '2'); ?>>
                        </span>
                    </div> 
                </div>
